...
public class DataAdapter extends RecyclerView.Adapter<DataAdapter.ViewHolder> {
    ...
    private final List<String> dataList;  // Lista de datos que se mostrarán en el RecyclerView
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_data_display, parent, false);
